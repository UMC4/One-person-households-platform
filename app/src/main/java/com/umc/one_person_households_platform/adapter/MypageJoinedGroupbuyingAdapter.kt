...
import com.umc.one_person_households_platform.view.mypage.MypageJoinedGroupBuyingFragment


class MypageJoinedGroupbuyingAdapter(private val heartList: List<CommunityBuyPost>) : RecyclerView.Adapter<MypageJoinedGroupbuyingAdapter.ViewHolder>() {
